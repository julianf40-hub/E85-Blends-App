...
> Active checklist items are tracked in `docs/TODO_ACTIVE.md`. Historical completed entries are archived in `docs/archive/legacy-planning/todo-history.md`.
...
- [x] Remove real API key from eas.json (was <your-nrel-api-key>)
...
- [x] Created docs/archive/2026-handoff/STATIONS_AUDIT.md: Comprehensive audit report with failure flow and fixes
