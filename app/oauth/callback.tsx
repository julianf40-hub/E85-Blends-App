  ...
  useEffect(() => {
    const handleCallback = async () => {
      try {
        ...
        if (error) {
          console.error("[OAuth] OAuth callback returned an error");
          setStatus("error");
        ...
        if (params.code && params.state) {
          ...
          try {
            ...
            console.error("[OAuth] Failed to parse callback URL, trying fallback parsing");
        ...
        if (result.sessionToken) {
          ...
          console.error("[OAuth] No session token in OAuth exchange result");
          setStatus("error");
