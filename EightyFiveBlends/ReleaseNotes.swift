...
enum ReleaseNotes {
    ...
    static let currentHighlights: [String] = [
        ...
        "85Blends Pro now includes an interactive Stations map for quickly browsing nearby E85, favorites, directions, and Trip Planner stops.",
        "Pro users can choose between the new Map layout and the Classic Stations layout from Preferences.",
        "Share any E85 station's name and full address directly from Stations — available to Free and Pro users.",
